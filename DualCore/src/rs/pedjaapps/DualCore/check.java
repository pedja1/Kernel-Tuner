...
saf=false;
			...
			try {
				...
				File myFile = new File("/sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels");
				FileInputStream fIn = new FileInputStream(myFile);		
			...
			try {
				...
				File myFile = new File("/sys/devices/system/cpu/cpu0/cpufreq/stats/time_in_state");
				FileInputStream fIn = new FileInputStream(myFile);
...
cd=false;
			...
			try {
				...
				File myFile = new File("/sys/class/misc/fsynccontrol/fsync_enabled");
				FileInputStream fIn = new FileInputStream(myFile);	
				count = count+1;
				fs=true;
			} catch (IOException e) {
