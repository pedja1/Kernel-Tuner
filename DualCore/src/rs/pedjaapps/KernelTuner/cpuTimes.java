...
public class cpuTimes extends ListActivity{
	...
	List<String> percent1 = new ArrayList<String>();
	List<String> frequencies1 = new ArrayList<String>();
	List<Integer> perint1 = new ArrayList<Integer>();
	String mynewstring;
	int itemCount;
