...
public enum LogcatLevel {
	...
	private static LogcatLevel[] byOrder = new LogcatLevel[6];
	...
	private LogcatLevel(int value, String hexColor, int titleId) {
		mValue = value;
		mHexColor = hexColor;
	...
	public static LogcatLevel getByOrder(int value) {
