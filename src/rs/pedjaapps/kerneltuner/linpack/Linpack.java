...
public class Linpack {
	...
	static Bundle mInfo;
  public static void main(Bundle info)
  {
  ...
  public void run_benchmark() 
  {
	...
	mflops_result = ops/(1.0e6*total);
	  ...
	  mInfo.putDouble(Tester.MFLOPS, mflops_result);
	  mInfo.putDouble(Tester.RESIDN, residn_result);
	  mInfo.putDouble(Tester.TIME, time_result);
	  mInfo.putDouble(Tester.EPS, eps_result);
