...
public class CPUActivity extends Activity
{
    ...
    private void updateUI()
    {
        ...
        cpu0minSeek.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
        {
                                          ...
                                          boolean fromUser)
            {
                ...
                if (size > progress)
                {
                    cpu0min.setText(frequencies.get(progress).getFrequencyString());
                }
            ...
            public void onStopTrackingTouch(SeekBar seekBar)
            {
                if (seekBar.getProgress() > frequencies.indexOf(IOHelper.cpu0MaxFreq()))
                {
                    ...
                    {
                        cpu0minSeek.setProgressAndThumb(origProg);
                        cpu0min.setText(frequencies.get(origProg).getFrequencyString());
                    }
                }
                else
                {

                    new FrequencyChanger(c).execute("cpu0", "min", frequencies.get(prog) + "");
                    if (cb.isChecked())
                    {
                        if (cpu1Online)
                        {
                            new FrequencyChanger(c).execute("cpu1", "min", frequencies.get(prog) + "");
                        }
                        if (cpu2Online)
                        {
                            new FrequencyChanger(c).execute("cpu2", "min", frequencies.get(prog) + "");
                        }
                        if (cpu3Online)
                        {
                            new FrequencyChanger(c).execute("cpu3", "min", frequencies.get(prog) + "");
                        }
        ...
        cpu0maxSeek.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
        {
                                          ...
                                          boolean fromUser)
            {
                ...
                if (size > progress)
                {
                    cpu0max.setText(frequencies.get(progress).getFrequencyString());
                }
            ...
            public void onStopTrackingTouch(SeekBar seekBar)
            {
                ...
                {
                    new FrequencyChanger(c).execute("cpu0", "max", frequencies.get(prog) + "");
                    if (cb.isChecked())
                    {
                        if (cpu1Online)
                        {
                            new FrequencyChanger(c).execute("cpu1", "max", frequencies.get(prog) + "");
                        }
                        if (cpu2Online)
                        {
                            new FrequencyChanger(c).execute("cpu2", "max", frequencies.get(prog) + "");
                        }
                        if (cpu3Online)
                        {
                            new FrequencyChanger(c).execute("cpu3", "max", frequencies.get(prog) + "");
                        }
                    }
                }
        ...
        if (cpu1Online)
        {
            ...
            cpu1minSeek.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
            {
                                              ...
                                              boolean fromUser)
                {
                    ...
                    if (size > progress)
                    {
                        cpu1min.setText(frequencies.get(progress).getFrequencyString());
                    }
                ...
                public void onStopTrackingTouch(SeekBar seekBar)
                {
                    ...
                    if (seekBar.getProgress() > frequencies.indexOf(IOHelper.cpu1MaxFreq()))
                    {
                        ...
                        catch (Exception e)
                        {
                            ...
                            cpu1min.setText(frequencies.get(origProg).getFrequencyString());
                        }
                    }
                    else
                    {
            ...
            cpu1maxSeek.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
            {
                                              ...
                                              boolean fromUser)
                {
                    ...
                    if (size > progress)
                    {
                        cpu1max.setText(frequencies.get(progress).getFrequencyString());
                    }
        ...
        if (cpu2Online)
        {
            ...
            cpu2minSeek.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
            {
                                              ...
                                              boolean fromUser)
                {
                    ...
                    if (size > progress)
                    {
                        cpu2min.setText(frequencies.get(progress).getFrequencyString());
                    }
                ...
                public void onStopTrackingTouch(SeekBar seekBar)
                {
                    ...
                    if (seekBar.getProgress() > frequencies.indexOf(IOHelper.cpu2MaxFreq()))
                    {
                        ...
                        catch (Exception e)
                        {
                            ...
                            cpu2min.setText(frequencies.get(origProg).getFrequencyString());
                        }
                    }
                    else
                    {
            ...
            cpu2maxSeek.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
            {
                                              ...
                                              boolean fromUser)
                {
                    ...
                    if (size > progress)
                    {
                        cpu2max.setText(frequencies.get(progress).getFrequencyString());
                    }
        ...
        if (cpu3Online)
        {
            ...
            cpu3minSeek.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
            {
                                              ...
                                              boolean fromUser)
                {
                    ...
                    if (size > progress)
                    {
                        cpu3min.setText(frequencies.get(progress).getFrequencyString());
                    }
                ...
                public void onStopTrackingTouch(SeekBar seekBar)
                {
                    ...
                    if (seekBar.getProgress() > frequencies.indexOf(IOHelper.cpu3MaxFreq()))
                    {
                        ...
                        catch (Exception e)
                        {
                            ...
                            cpu3min.setText(frequencies.get(origProg).getFrequencyString());
                        }
                    }
                    else
                    {
            ...
            cpu3maxSeek.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
            {
                                              ...
                                              boolean fromUser)
                {
                    ...
                    if (size > progress)
                    {
                        cpu3max.setText(frequencies.get(progress).getFrequencyString());
                    }
    ...
    private void cpuTemp(String tmp)
    {
    ...
    private void populateGovernorSpinners()
    {
        ...
        if (cpu0Online)
        {
            ...
            gov1spinner.setOnItemSelectedListener(new OnItemSelectedListener()
            {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id)
                {
                    new ChangeGovernor(c).execute("cpu1", parent.getItemAtPosition(pos).toString());
        ...
        if (cpu2Online)
        {
            ...
            gov2spinner.setOnItemSelectedListener(new OnItemSelectedListener()
            {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id)
                {
                    new ChangeGovernor(c).execute("cpu2", parent.getItemAtPosition(pos).toString());
        ...
        if (cpu3Online)
        {
            ...
            gov3spinner.setOnItemSelectedListener(new OnItemSelectedListener()
            {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id)
                {
                    new ChangeGovernor(c).execute("cpu3", parent.getItemAtPosition(pos).toString());
