...
public class Initd extends AsyncTask<String, Void, String>
{
	...
	protected String doInBackground(String... args)
	{
		...
		RootExecuter.exec(new String[]{
	            ...
	            "/data/data/rs.pedjaapps.KernelTuner/files/cp /data/data/rs.pedjaapps.KernelTuner/files/99ktcputweaks /system/etc/init.d\n",
	            "chmod 777 /system/etc/init.d/99ktcputweaks\n",
	            "/data/data/rs.pedjaapps.KernelTuner/files/cp /data/data/rs.pedjaapps.KernelTuner/files/99ktgputweaks /system/etc/init.d\n",
